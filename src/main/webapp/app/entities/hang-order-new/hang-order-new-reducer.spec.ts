...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HANGORDERNEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_HANGORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HANGORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HANGORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HANGORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HANGORDERNEW actions', async () => {
      const expectedActions = [
        {
