...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fund.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUND_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUND actions', async () => {
      const expectedActions = [
        {
