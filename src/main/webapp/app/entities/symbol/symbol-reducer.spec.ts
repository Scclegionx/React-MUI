...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './symbol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYMBOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SYMBOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYMBOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYMBOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYMBOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYMBOL actions', async () => {
      const expectedActions = [
        {
