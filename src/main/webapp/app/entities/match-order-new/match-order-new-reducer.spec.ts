...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATCHORDERNEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATCHORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATCHORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATCHORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATCHORDERNEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATCHORDERNEW actions', async () => {
      const expectedActions = [
        {
