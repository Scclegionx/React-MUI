...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATCHORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATCHORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATCHORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATCHORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATCHORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATCHORDER actions', async () => {
      const expectedActions = [
        {
