...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HANGORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_HANGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HANGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HANGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HANGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HANGORDER actions', async () => {
      const expectedActions = [
        {
